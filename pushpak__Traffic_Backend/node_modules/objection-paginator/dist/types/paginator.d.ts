 ...
 */
export declare type If<T> = T extends undefined ? [] : [T];
/**
...
export interface PaginatorConstructor<TModel extends Model, TArgs = undefined> {
    new (options?: PaginatorOptions, ...rest: If<TArgs>): Paginator<TModel, TArgs>;
}
/**
 ...
 */
export declare abstract class Paginator<TModel extends Model, TArgs = undefined> {
    /**
     ...
     * 	 any.
     */
    static getPage<TModel extends Model, TArgs = undefined>(this: PaginatorConstructor<TModel, TArgs>, options?: GetPageOptions, ...rest: If<TArgs>): Promise<Page<TModel>>;
    /**
     * Gets an identifier to include and check in cursors.
     * @returns The queryName property, if specified, or the constructor name
     *   if not.
     */
    private static _getQueryName;
    /**
     ...
     */
    private static _createSortNodes;
    /**
     ...
     */
    execute(cursor?: string | null): Promise<Page<TModel>>;
    /**
